...
import com.example.mystories.DataDummy
import com.example.mystories.MainDispatcherRule
import com.example.mystories.api.ListStoryItem
import com.example.mystories.getOrAwaitvalue
import com.example.mystories.repository.StoryRepository
import com.example.mystories.ui.StoryAdapter
...
class HomeViewModelTest{
    @get:Rule
    val instantExcetorRule = InstantTaskExecutorRule()
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        val actualStory = homeViewModel.storyPaging.getOrAwaitvalue()
